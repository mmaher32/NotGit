...
#Git Add file.txt -> index store metadata about file.txt
#This class represents the file inside Git index
...
def add(repo, paths, delete=True, skip_missing=False):
    ...
    #
    # @FIXME,  just move the index through
...
# =========================
"""
NotGit hash-object [-w] [-t TYPE] FILE
"""
argsp = argsubparsers.add_parser(
    "hash-object",
...
argsp.add_argument("--NotGit-type",
                   metavar="type",
                   dest="type",
                   choices=["blob", "commit", "tag", "tree"],
                   default=None,
...
def tag_create(repo, name, ref, create_tag_object=False):
    ...
    if create_tag_object:
        ...
        tag.kvlm[b'tagger'] = b'NotGit <NotGit@example>'
        # and a tag message
        tag.kvlm[None] = b"A tag generated by NotGit, which won't let you customize the message!\n"
